            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <svg class="w-auto h-12 text-white lg:h-16 lg:text-primary" viewBox="0 0 62 65" fill="none"
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="https://laravel.com/docs" id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-base-500 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-white/70 hover:ring-white/20 focus:outline-none focus-visible:ring-primary md:row-span-3 lg:p-10 lg:pb-10">
                            <div id="screenshot-container" class="relative flex items-stretch flex-1 w-full">
                                <img src="https://laravel.com/assets/img/welcome/docs-dark.svg"
                                    ...
                                    class="block aspect-video h-full w-full flex-1 rounded-[10px] object-top object-cover drop-shadow-[0px_4px_34px_rgba(0,0,0,0.25)]" />
                                <div
                                    class="absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-base-500 to-base-500">
                                </div>
                            </div>
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        class="flex items-center justify-center rounded-full size-12 shrink-0 bg-base-200 sm:size-16">
                                ...
                                <svg class="size-6 shrink-0 stroke-primary" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a href="https://laracasts.com"
                            class="flex items-start gap-4 rounded-lg bg-base-500 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-white/70 hover:ring-white/20 focus:outline-none focus-visible:ring-primary lg:pb-10">
                            <div
                                class="flex items-center justify-center rounded-full size-12 shrink-0 bg-base-200 sm:size-16">
                                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-white">Laracasts</h2>
                            ...
                            <svg class="size-6 shrink-0 self-center stroke-[#f5c387]" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
                            </svg>
                        ...
                        <a href="https://laravel-news.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-white">Laravel News</h2>
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-white">Vibrant Ecosystem</h2>
